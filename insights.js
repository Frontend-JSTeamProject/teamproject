...
const solutionsWrapper = document.querySelector('.insights_wrapper');
...
// firm 하위메뉴
const solutionPop = document.querySelector('nav #nav_list .insights_pop');
...
const scrollSolutionPop = document.querySelector('header #header_nav_list .insights_pop');
